...
if(!is_null($txEmail)){
	...
	VALUES('','".$rq[nombre]."','".$rq[apellido]."','".$txEmail."','".$rq[telefono]."','".$duplicated."','0','".$state."','".$dCreated."','".$_SERVER[HTTP_REFERER]."','".$_SERVER[REMOTE_ADDR]."','".$_SERVER[HTTP_USER_AGENT]."','1','".$argmon."')";
	try {
