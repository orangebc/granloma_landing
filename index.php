...
<html lang="en">
		...
		<div class="container-fluid">
			...
			<div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
				<div class="header__info">
					...
					<span class="fa fa-envelope header__icon"></span><span class="header__info--email">laloma@ideasinmobiliarias.com</span>
	...
	<section id="slider" class="slider nivoSlider">
		...
		<img src="images/slide4.jpg" data-transition="boxRainGrow" alt="slide-4">
	</section>
	<!-- PHRASE -->
	<section class="phrase">
		<div class="container text-center">
			<h1 class="phrase__title">Lotes con todos los servicios y excelentes amenities ubicados en la zona más exclusiva de lomas de angelópolis.</h1>
			<small class="phrase__subtitle">Entrega en Julio 2015</small>
			<small class="phrase__subtitle">Créditos hipotecarios disponibles para compra de terreno, financiamiento para casa y terreno."</small>
		</div>
	</section>
	<!-- MAIN -->
	<main class="main">
		<div class="container text-center">
			<p class="main__info">Ubicado dentro del Kluster Cascatta, <strong>LA LOMA GRAN RESERVA</strong> cuenta con áreas verdes, parques, bancos, restaurantes, comercios, oficinas y la Plaza Comercial Cascatta, una de las más grandes de Puebla.</p>
			<p class="main__info">Su CERCANÍA con las CASCADAS, las increíbles vistas a los volcanes, además de un plan de movilidad y sustentabilidad de primer mundo,  hace a LA LOMA GRAN RESERVA el mejor lugar en Lomas de Angelópolis.</p>
		</div>
	</main>
	<!-- AMENIDADES -->
	<section class="amenidades text-center">
		<div class="container">
			...
			<div class="amenidades__icons">
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-4">
						...
						<h5 class="amenidades__icons--info">Sala de <br> proyecciones</h5>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4">
						<figure class="amenidades__icons--icon">
			...
			<div class="amenidades__images">
				<div class="row">
					<div class="col-lg-4 no-space">
						<img src="images/gal-1.jpg" class="amenidades__gallery" alt="gallery-1">
					</div>
					<div class="col-lg-4 no-space">
						<img src="images/gal-2.jpg" class="amenidades__gallery" alt="gallery-2">
					</div>
					<div class="col-lg-4 no-space">
						<img src="images/gal-3.jpg" class="amenidades__gallery" alt="gallery-3">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="ubicacion text-center">
		<div class="container">
			...
			<div class="ubicacion__map">
				<img src="images/ubicacion.png" alt="mapa-de-ubicacion">
			</div>
		</div>
	</section>
	<!-- LOTES -->
	<section class="lotes text-center">
		<div class="container-fluid">
			<h2 class="green__title">Lotes</h2>
			<div class="row">
				<div class="col-lg-6 no-space">
					<img src="images/lotes-1.jpg" class="lotes__img" alt="lotes-1">
				</div>
				<div class="col-lg-6 no-space">
					<img src="images/lotes-2.jpg" class="lotes__img" alt="lotes-2">
				</div>
			</div>
			<h5 class="lotes__info"><strong>INFORMES</strong> <br> Atlixcayotl 5208 Col. Tlaxcalcingo (reserva territorial Angelópolis), <br> San Andrés Cholula, Puebla <br> <strong>TEL. (222) 169-17-18</strong></h5>
		</div>
	</section>
	<!-- LOGOS -->
	<section class="logos">
		<div class="container-fluid">
			<div class="col-lg-3 col-md-3 col-sm-6 text-center">
				<img src="images/logo-1.png" class="logos__logo" alt="logo-1">
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6 text-center">
				<img src="images/logo-2.png" class="logos__logo" alt="logo-2">
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6 text-center">
				<img src="images/logo-3.png" class="logos__logo" alt="logo-3">
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6 text-center">
				<img src="images/logo-4.png" class="logos__logo" alt="logo-4">
			</div>
		</div>
	</section>
	<!-- FOOTER -->
